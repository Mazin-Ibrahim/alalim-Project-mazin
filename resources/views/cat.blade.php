      ...
      <div class="row">
        ...
        <div class="col-md-4">
            <select id="inputState" class="form-control">
              <option selected>اختار التصنيف...</option>
        ...
        <section class="content content--fill">
          <div class="container">
            ...
            <div class="product-category-carousel mobile-special-arrows animated-arrows slick">
              <div class="product-category hover-squared text-center"> <a href="#"><img src="images/products/product-500x500.jpg" data-lazy="images/products/product-500x500.jpg" alt="#"></a>
              ...
              <div class="product-category hover-squared"> <a href="#"><img src="images/products/product-500x500.jpg" data-lazy="images/products/product-500x500.jpg" alt="#"></a>
                <div class="product-category__hover caption"></div>
                <div class="product-category__info">
                  <div class="product-category__info__ribbon">
        ...
        <section class="content games">
          <div class="container">
            <h2 class="text-center text-uppercase">تسوق العاب الفيديو</h2>
            <div class="row">
              <div class="col-md-3">
                <div class="games-cricle">
                  <img src="images/slides/p1.png" alt="">
                </div>
              ...
              <div class="col-md-3">
                <div class="games-cricle">
                  <img src="images/slides/p4.png" alt="">
                </div>
                <div class="divider divider--sm"></div>
              ...
              <div class="col-md-3">
                <div class="games-cricle">
                  <img src="images/slides/p6.png" alt="">
                </div>
                <div class="divider divider--sm"></div>
                <h4 class="text-center">pc games</h4>
              </div>
              <div class="col-md-3">
                <div class="games-cricle">
                  <img src="images/slides/p7.png" alt="">
                </div>
                <div class="divider divider--sm"></div>
                <h4 class="text-center">PS6</h4>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-3">
                <div class="games-cricle">
                  <img src="images/slides/p3.png" alt="">
                </div>
                <div class="divider divider--sm"></div>
                <h4 class="text-center">PS4</h4>
              </div>
              <div class="col-md-3">
                <div class="games-cricle">
                  <img src="images/slides/p2.png" alt="">
                </div>
                <div class="divider divider--sm"></div>
                <h4 class="text-center">xbox</h4>
              </div>
